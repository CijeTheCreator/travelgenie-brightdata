...
export default function ChatPage() {
  ...
  const exampleMessages = [
    "Plan a 4-day trip to Barcelona in late September with a flight from Boston and a centrally located hotel",
    "Compare hotel prices in Dubai for a 5-day stay starting August 10th",
  ];
